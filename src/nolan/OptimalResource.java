...
public class OptimalResource {
    ...
    // copyPath returns a copy of the path of length pathLength
    public static MapLocation[] copyPath(MapLocation[] path, int pathLength) {
        MapLocation[] newPath = new MapLocation[pathLength];
